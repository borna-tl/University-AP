CC := g++ -std=c++11
all: utrip.out
utrip.out: main.o ReadFile.o Application.o Filter.o Hotel.o Rating.o Room.o User.o Reservation.o Hash.o Errors.o
	$(CC) main.o ReadFile.o Application.o Filter.o Hotel.o Rating.o Room.o User.o Reservation.o Hash.o Errors.o -o utrip.out
...
User.o: User.cpp User.hpp Hash.hpp Reservation.hpp

...
void Hotel::add_rating (double location, double cleanliness, double staff, double facilities, double value, double overall, string username){
    ratings->add(location, cleanliness, staff, facilities, value, overall, username);
}
